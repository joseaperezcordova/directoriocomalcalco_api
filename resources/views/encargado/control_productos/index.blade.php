...
@section('title','Control de Productos - Encargado')
...
{{-- Modal Recepción --}}
@include('encargado.control_productos.modals.recepcion')

{{-- Modal Entrega --}}
@include('encargado.control_productos.modals.entrega')
...
@section('scripts')
@include('encargado.control_productos.scripts')
@endsection
